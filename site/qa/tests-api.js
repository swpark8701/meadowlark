...
suite('API tests', function(){
    ...
    var attraction = {
        ...
        description: 'Founded in 1892, the Portland Art Museum\'s collection of native art is not to be missed. If modern art is more to your liking, there are six stories of modern art for your enjoyment.',
        email: 'test@psw.com'
    };
